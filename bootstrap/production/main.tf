# Bootstrap: production account. Creates this account's "tf-exec" IAM
...
# config creates it:
#
#   cd bootstrap/production
#   terraform init
#   terraform apply
#
# After this applies, envs/prod's provider assumes into the tf_exec_role_arn
# this outputs.
...
# comment). Scoping this down to exactly what envs/prod's modules
